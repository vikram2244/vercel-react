                    ...
                    <div className="container">
                        <div className="row justify-content-lg-center">
                            <div className="col-12 col-lg-9">
                                <div className="resume-wrap border rounded shadow-lg overflow-hidden">
                                    <form onSubmit={handleSubmit}>
                                        <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
                                            <div className="col-12">
                                                <label htmlFor="fullname" className="form-label">Full Name <span className="text-danger">*</span></label>
                                                <input type="text" className="form-control" id="fname" name="fname" value="" required />
                                            </div>
                                            ...
                                            <div className="col-12 col-md-6">
                                                ...
                                                <div className="input-group">
                                                    ...
                                                    <input type="tel" className="form-control" id="phnnum" name="phnnum" value="" />
                                                </div>
                                            </div>
                                            <div className="col-12">
